...
# Main module for training the SFA network on a given dataset
# Written by Shi Luo
# -----------------------------------------------------------

from SFA.train import train_net, get_training_roidb
import argparse
import numpy as np
...
def parser():
    parser = argparse.ArgumentParser('SFA Train Module!',
    ...
    parser.add_argument('--solver', dest='solver_proto', help='SFA caffe solver prototxt',
                        default='SFA/models/solver_sfa.prototxt', type=str)
