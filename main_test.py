...
# Main module for evaluating the SFA on a given dataset
# Written by Shi Luo
# -----------------------------------------------------

from SFA.test import test_net
import argparse
...
def parser():
    parser = argparse.ArgumentParser('SFA Evaluate Module!',
